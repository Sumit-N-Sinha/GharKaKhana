...
public class CustomerController {
	...
	@GetMapping("/findbyFood/{name}")
	public ResponseEntity<List<FoodItems>> findByFood(@PathVariable("name") String name){
		return new ResponseEntity<>(cs.findByFood(name),HttpStatus.OK);
    }
}